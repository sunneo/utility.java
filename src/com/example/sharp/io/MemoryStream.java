...
public class MemoryStream extends InputStream implements IDisposable, ISeekableStream {
	...
	/**
	 * Initializes a new instance of the MemoryStream class with an expandable
	...
	/**
	 * Initializes a new non-resizable instance of the MemoryStream class based on
	 * the specified byte array.
	 *
	 * @param buffer The array of unsigned bytes from which to create the current
	 *               stream.
	 */
	...
	/**
	 * Initializes a new non-resizable instance of the MemoryStream class based on
	 * the specified byte array, with writable set as specified.
	 *
	...
	/**
	 * Initializes a new non-resizable instance of the MemoryStream class based on
	 * the specified region of a byte array.
	 *
	 * @param buffer The array of unsigned bytes from which to create this stream.
	...
	/**
	 * Initializes a new non-resizable instance of the MemoryStream class based on
	 * the specified region of a byte array, with writable set as specified.
	 *
	 * @param buffer   The array of unsigned bytes from which to create this stream.
	 * @param index    The index into buffer at which the stream begins.
	 * @param count    The length of the stream in bytes.
	 ...
	 * region of a byte array, with writable set as specified, and publiclyVisible
	 * set as specified.
	 *
	 * @param buffer          The array of unsigned bytes from which to create this
	 *                        stream.
	 * @param index           The index into buffer at which the stream begins.
	 * @param count           The length of the stream in bytes.
	 * @param writable        Whether the stream supports writing.
	 * @param publiclyVisible Whether the stream allows direct access to the
	 *                        underlying buffer.
	 */
	...
	public synchronized long skip(long n) {
		...
		long newPosition = 0;
		try {
			newPosition = seek(n, SeekOrigin.CURRENT);
		} catch (Exception e) {
			e.printStackTrace();
		}
	 ...
	 *
	 * @return byte[] The byte array from which this stream was created, or the
	 *         underlying array if a byte array was not provided to the MemoryStream
	 *         constructor during construction of the current instance.
	 */
	public byte[] getBuffer() throws Exception {
		if (!bufferVisible)
			throw new Exception("Cannot call getBuffer().");
	 ...
	 *
	 * @param value The new length of the usable portion of the buffer for the
	 *              stream.
	 */
	...
	public void setLength(long value) throws Exception {
		if (value < 0)
			throw new Exception("MemoryStream length must be non-negative.");
		if (!writable)
	 ...
	 * @param loc    A value of type SeekOrigin, which acts as the seek reference
	 *               point.
	 * @return The new position within the stream, calculated by combining the
	 ...
	 * @param offset The zero-based byte offset in buffer at which to begin copying
	...
	/**
	 * Get an OutputStream that will write to this MemoryStream, at the current
	 * position.
	 *
